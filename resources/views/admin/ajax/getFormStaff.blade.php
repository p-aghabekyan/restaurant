<div class="main" style="margin-top: 10px">
    ...
    <div class="row">
        <div class="col-md-12" style="margin-bottom: 10px">
            ...
            <input type="text" name="data[{{ $data['count'] }}][firstname]" placeholder="First Name" class="form-control name" id="name" required>
        </div>
        <div class="col-md-11" style="margin-bottom: 10px">
            <label for="name" class="control-label">Last Name</label>
            <input type="text" name="data[{{ $data['count'] }}][lastname]" placeholder="Last Name" class="form-control name" id="name" required>
        </div>

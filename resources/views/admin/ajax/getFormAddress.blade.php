<div class="main" style="margin-top: 10px">
    ...
    <div class="row">
        ...
        <div class="col-md-12" style="margin-bottom: 10px">
            ...
            <textarea name="data[{{ $data['count'] }}][description]" id="desc" cols="30" rows="10" class="form-control">

            </textarea>
        </div>
        <div class="col-md-11">
            <label for="address" class="control-label">Address</label>
            <input type="text" name="data[{{ $data['count'] }}][address]" placeholder="Address" class="form-control address" id="address" required value="{{ old('address') }}">
        </div>
